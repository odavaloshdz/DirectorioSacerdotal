...
export async function GET() {
  try {
    ...
    // Execute raw SQL to create tables (equivalent to prisma db push)
    ...
    const createTablesSQL = `
      ...
      CREATE UNIQUE INDEX IF NOT EXISTS "priests_userId_key" ON "priests"("userId");
      CREATE UNIQUE INDEX IF NOT EXISTS "priestSpecialties_priestId_specialtyId_key" ON "priestSpecialties"("priestId", "specialtyId");
